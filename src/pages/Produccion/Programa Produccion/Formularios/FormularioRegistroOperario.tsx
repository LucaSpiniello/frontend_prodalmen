...
import { fetchListaOperariosEnPrograma, fetchProgramaProduccion } from "../../../../redux/slices/produccionSlice"
...
const FormularioRegistroOperarioPrograma: FC<IFormCamiones> = ({ setOpen }) => {
  const { id } = useParams()
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        const res = await fetchWithTokenPost(`api/produccion/${id}/registrar_operario/`, 
        {
