        ...
        <View style={[styles.header, { paddingVertical: 10}]}>
          <View style={styles.header_superior}>
            ...
            <Text style={{ width: 220, textAlign: 'center', fontSize: 14, position: 'relative', left: 18, top: 10}}>
              ...
              desde el <br></br> {format(state.desde)} hasta el {format(state.hasta)}
            </Text>
          ...
          <Text style={{ textAlign: 'center', fontSize: 10, fontWeight: 'bold', marginTop: 10, }}>Listado de Tarjas Resultantes en el Periodo</Text>
          ...
          <View style={{ 
            ...
            <View style={styles.header_info_box_superior}>
             <Text style={{ fontSize: 10, position: 'relative', top: -5}}>Kilos Neto</Text>
            </View>
