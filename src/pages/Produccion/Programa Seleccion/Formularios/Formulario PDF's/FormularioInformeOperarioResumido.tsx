    ...
    onSubmit: async (values: any) => {
      try {
        ...
        if (res.ok){
          ...
          navigate('/pro/seleccion/programa-seleccion/pdf-informe-operario-resumido/', { state: { operarios: data, desde: state[0].startDate, hasta: state[0].endDate, pathname: pathname  }})
