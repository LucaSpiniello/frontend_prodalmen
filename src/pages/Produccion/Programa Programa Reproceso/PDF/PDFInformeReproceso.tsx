...
const PDFInformeReproceso = () => {
  ...
  return (
    <PDFViewer style={{ height: '100%'}}>
      <Document title='Documento Informe Programas Reproceso'>
        <Page>
        <View style={[styles.header, { paddingVertical: 10}]}>
          <View style={styles.header_superior}>
            ...
            <View style={{ width: 150, border: '1px solid green', height: 35, padding: 5, borderRadius: 2, position: 'relative', top: -10 }}>
              ...
              <View style={styles.header_date_info_box}>
                ...
                <Text style={styles.header_date_info_text}>{userData?.first_name} {userData?.last_name}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={{
            ...
            <View style={{
              ...
              <View style={styles.header_date_info_box}>
                ...
                <Text style={styles.header_date_info_text}>{state.reproceso.total_kilos_procesados} Kgs</Text>
              </View>
          ...
          <View style={{ 
            ...
            <View style={styles.header_info_box_superior}>
             <Text style={{ fontSize: 10, position: 'relative', top: -5}}>Kilos Ingresados</Text>
            </View>

            <View style={styles.header_info_box_superior}>
             <Text style={{ fontSize: 10, position: 'relative', top: -5}}>Kilos Resultantes</Text>
            </View>
            ...
            <View style={styles.header_info_box_superior}>
             <Text style={{ fontSize: 10, position: 'relative', top: -5}}>Duración</Text>
            </View>

          </View>

          {
            state?.reproceso.detalle_programas.map((programa: any) => {
              return (
                <View key={programa.tarja} style={{ 
                  ...
                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{programa.numero_programa}</Text>
                  </View>

                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{programa.total_kilos_ingresados} kgs</Text>
                  </View>


                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{programa.total_kilos_salientes} kgs</Text>
                  </View>

                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{format(programa.fecha_creacion, { date: 'short', time: 'short'}, 'es' )}</Text>
                  </View>

                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{programa.dias_duracion}</Text>
                  </View>
...
export default PDFInformeReproceso