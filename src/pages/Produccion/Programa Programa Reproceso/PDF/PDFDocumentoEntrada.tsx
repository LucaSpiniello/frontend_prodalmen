    ...
    <PDFViewer style={{ height: '100%'}}>
      <Document>
        ...
        <View style={styles.header}>
          ...
          {
            bins?.map((tarja: TBinEnReproceso) => {
              return (
                <View style={{ 
                  width: '100%',
                  height: 30,
                  ...
                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 10}}>{(tarja.kilos_bin ?? 0).toLocaleString()}</Text>
                  </View>
      
                  <View style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    {
                      tarja.bin_procesado 
                        ? <Image source={`/src/assets/checkedcheckbox.png`} style={{ width: '20%', height: '50%'}}/>
                        : <Image source={`/src/assets/uncheckedcheckbox.png`} style={{ width: '20%', height: '50%'}}/>
                    }
                  </View>
                </View>
              )
