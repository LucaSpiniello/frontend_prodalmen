...
import { fetchOperarioPrograma, 
	// fetchOperariosProduccion 
} from '../../../../../redux/slices/produccionSlice';
...
const TablaDetalleDarioOperario = ({ rut }: { rut: string | undefined } ) => {
	...
	const [globalFilter, setGlobalFilter] = useState<string>('')
  	const operario = useAppSelector((state: RootState) => state.reproceso.operario_reproceso_individual)
    ...
    try {
      ...
      if (response.ok){
        ...
        //@ts-ignore
				// dispatch(fetchOperariosProduccion({ id: id_programa, token, verificar_token: verificarToken }))
  ...
  const columnHelper = createColumnHelper<TOperarioReproceso>();
  const columns = [
