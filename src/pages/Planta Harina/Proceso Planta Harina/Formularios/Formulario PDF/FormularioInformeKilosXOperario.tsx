  ...
  const formik = useFormik({
    ...
    onSubmit: async (values: any) => {
      try {
        ...
        const res = await fetchWithTokenPost(`api/procesos/pdf_kilos_por_operario/`,
          {
            ...values,
          },
          token_verificado
        ...
        if (res.ok){
          ...
          navigate('/ph/ph-proc/pdf-informe-kilos-x-operario', { state: { programas: data, desde: values.desde, hasta: values.hasta, pathname: pathname, operario: `${operario?.nombre} ${operario?.apellido}` }})
        }
      } catch (error) {
