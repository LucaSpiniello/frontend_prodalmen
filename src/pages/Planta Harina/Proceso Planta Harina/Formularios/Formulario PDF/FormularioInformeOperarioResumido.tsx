  ...
  const formik = useFormik({
    ...
    onSubmit: async (values: any) => {
      try {
        ...
        const res = await fetchWithTokenPost(`api/procesos/pdf_informe_operario_resumido/`,
          {
            ...values,
        ...
        if (res.ok){
          ...
          navigate('/ph/ph-proc/pdf-informe-operario-resumido/', { state: { operarios: data, desde: state[0].startDate, hasta: state[0].endDate, pathname: pathname  }})
