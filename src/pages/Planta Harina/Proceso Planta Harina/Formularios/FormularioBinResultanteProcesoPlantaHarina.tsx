...
import { registrar_bin_resultante_proceso_planta_harina } from '../../../../redux/slices/procesoPlantaHarina'

const FormularioBinResultanteProcesoPlantaHarina = ({ setOpen }: { setOpen : Dispatch<SetStateAction<boolean>>}) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(registrar_bin_resultante_proceso_planta_harina({
        id: parseInt(id!),
        params: { setOpen: setOpen, setDisabled: setDisabled },
        data: { 
          proceso: id,
          registrado_por: perfil?.id,
          tipo_patineta: values.tipo_patineta,
          calle_bodega: values.calle_bodega,
          peso: values.peso
        },
        token,
...
export default FormularioBinResultanteProcesoPlantaHarina
