...
const PDFInformeKilosXOperario = () => {
  ...
  const kilos_totales_fruta = state.programas?.reduce((acc: number, programa: any) => Number(programa.kilos) + acc, 0) ?? 0
  const total_neto = state.programas?.reduce((acc: number, programa: any) => Number(programa.neto) + acc, 0) ?? 0
  return (
        ...
        <View style={[styles.header, { paddingVertical: 10}]}>
          <View style={styles.header_superior}>
            ...
            <Text style={{ width: 220, textAlign: 'center', fontSize: 14, position: 'relative', left: 18, top: 10}}>
              Informe de Operario en Procesos Planta Harina
          ...
          <Text style={{ textAlign: 'center', fontSize: 10, fontWeight: 'bold', marginTop: 10 }}>Detalle por proceso</Text>
          ...
          <View style={{ 
            ...
            <View style={styles.header_info_box_superior}>
             <Text style={{ fontSize: 10, position: 'relative', top: -5}}>N° Proceso</Text>
            </View>
            ...
            state?.programas.map((programa: any) => {
              return (
                <View key={programa.programa} style={{ 
                  ...
                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 10 }}>{programa.proceso}</Text>
                  </View>
