      ...
      <Document>
        ...
        <View style={[styles.header, { paddingVertical: 10}]}>
          ...
          <View style={{ 
            ...
            <View style={styles.header_info_box_superior}>
             <Text style={{ fontSize: 10, position: 'relative', top: -5}}>Proceso</Text>
            </View>
            ...
            state?.bins_p_harina.map((pallet: any) => {
              return (
                ...
                <View style={styles.header_info_box_superior}>
                  ...
                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{pallet.proceso}</Text>
                  </View>
...
export default PDFInformeProcesoHarina