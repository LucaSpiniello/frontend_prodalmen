...
const FormularioInformeOperariosResumido: FC<IInformeProduccion> = ({ setOpen }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values: any) => {
      try {
        ...
        const res = await fetchWithTokenPost(`api/programas/pdf_informe_operario_resumido/`,
          {
            ...values,
        ...
        if (res.ok){
          ...
          navigate('/ph/ph-prog/pdf-informe-operario-resumido/', { state: { operarios: data, desde: state[0].startDate, hasta: state[0].endDate, pathname: pathname  }})
...
export default FormularioInformeOperariosResumido
