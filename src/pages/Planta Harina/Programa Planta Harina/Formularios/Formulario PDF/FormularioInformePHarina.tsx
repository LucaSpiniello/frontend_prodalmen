...
const FormularioInformePHarina: FC<IInformeProduccion> = ({ setOpen }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values: any) => {
      try {
        ...
        const res = await fetchWithTokenPost(`api/programas/pdf_informe_programa/`,
          {
            ...values,
        ...
        if (res.ok){
          ...
          navigate('/ph/ph-prog/pdf-informe-programa/', { state: { bins_p_harina: data, desde: state[0].startDate, hasta: state[0].endDate, pathname: pathname  }})
...
export default FormularioInformePHarina
