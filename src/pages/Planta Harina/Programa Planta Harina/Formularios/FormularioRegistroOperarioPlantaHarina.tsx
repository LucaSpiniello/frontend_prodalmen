...
import { fetchOperario, fetchOperarios, fetchOperariosFiltro, fetchOperariosWithSearch } from "../../../../redux/slices/operarioSlice"
import { ThunkDispatch } from '@reduxjs/toolkit';
import { useDispatch } from 'react-redux';
import { fetchOperariosPlantaHarina, fetchProgramaPlantaHarina } from "../../../../redux/slices/plantaHarinaSlice"
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        const res = await fetchWithTokenPost(`api/programas/${id}/registrar_operario/`, 
        {
