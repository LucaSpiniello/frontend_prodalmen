...
const PDFDocumentoEntradaSalidaPlantaHarina = () => {
  const { id } = useParams()
  ...
  const pdf = useAppSelector((state: RootState) => state.planta_harina.pdf_documento_salida)

  useEffect(() => {
    dispatch(fetchPDFSalidaPlantaHarina({ id: parseInt(id!), token, verificar_token: verificarToken }))
  }, [])


  return (
    <PDFViewer style={{ height: '100%'}}>
      <Document title={`Documento Salida Planta Harina N° ${id}`}>
        <Page>
              ...
              <View style={{
                ...
                <View style={[styles.header_date_info_box, { flexDirection: 'column'}]}>
                  <View style={styles.header_date_info_box}>
                    ...
                    <Text style={styles.header_date_info_text}>{pdf?.programa?.tipo_programa_label} </Text>
                  </View>
                  ...
                  <View style={styles.header_date_info_box}>
                    ...
                    <Text style={styles.header_date_info_text}>{pdf?.programa?.perdidaprograma} % </Text>
                  </View>
                ...
                <View style={[styles.header_date_info_box, { flexDirection: 'column'}]}>
                  <View style={styles.header_date_info_box}>
                    ...
                    <Text style={styles.header_date_info_text}>{pdf?.programa?.estado_programa_label} </Text>
                  </View>
...
export default PDFDocumentoEntradaSalidaPlantaHarina