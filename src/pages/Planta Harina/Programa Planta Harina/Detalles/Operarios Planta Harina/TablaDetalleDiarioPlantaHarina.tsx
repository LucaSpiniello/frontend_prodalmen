...
import { TOperarioPlantaHarina, TOperarioPlantaHarinaDiario } from '../../../../../types/typesPlantaHarina';
import { eliminar_dia_operario_planta_harina } from '../../../../../redux/slices/plantaHarinaSlice';

const TablaDetalleDarioOperarioPlantaHarina = ( ) => {
  const [sorting, setSorting] = useState<SortingState>([]);
	const [globalFilter, setGlobalFilter] = useState<string>('')
  const operario = useAppSelector((state: RootState) => state.planta_harina.operarios_planta_harina_diario)
  ...
  const columnHelper = createColumnHelper<TOperarioPlantaHarinaDiario>();
  const columns = [
        ...
        return (
          <div className=' h-full w-full flex items-center justify-center gap-5'>
            <Button
              ...
              onClick={() => dispatch(eliminar_dia_operario_planta_harina({ id: parseInt(id_programa!), data: { rut: row.rut_operario }, token, verificar_token: verificarToken }))}
              >
...
export default TablaDetalleDarioOperarioPlantaHarina