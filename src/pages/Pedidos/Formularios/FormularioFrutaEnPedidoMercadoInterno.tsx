...
import {fetchDespacho, fetchFrutaDespacho, fetchPedidoInterno } from '../../../redux/slices/pedidoSlice'
...
const FormularioFrutaEnPedidoMercadoInterno: FC<FrutaenPedidoProps> = ({ setOpen }) => {
  const { id } = useParams()
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values: any) => {
      ...
      const res = await fetchWithTokenPost(`api/pedidos_mercado_interno/${id}/frutas/`, 
        {
          pedido: id,
          ...values
        }, token_verificado)
...
export default FormularioFrutaEnPedidoMercadoInterno
