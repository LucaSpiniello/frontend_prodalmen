    ...
    columnHelper.display({
      ...
      cell: (info) => (
        <div className='w-full flex items-center justify-center'>
          {
            ['3', '4', '5'].includes(pedido_exportacion?.estado_pedido!)
              ? null
              : (
                <Button
                  variant='solid'
                  ...
                  onClick={() => {
                    dispatch(eliminarFrutaEnPedido({ id: pedido_exportacion?.id_pedido_padre, params: { id_fruta: info.row.original.id }, token, verificar_token: verificarToken}))
                  }}
                  >
...
export default TablaPedidoExportacion;
