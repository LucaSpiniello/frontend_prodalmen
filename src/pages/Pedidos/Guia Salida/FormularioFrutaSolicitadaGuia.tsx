...
const FormularioFrutaSolicitadaGuia: FC<FrutaenPedidoProps> = ({ setOpen }) => {
  const { id } = useParams()
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values: any) => {
      ...
      const res = await fetchWithTokenPost(`api/guias-salida/${id}/frutas/`, 
        {
          guiasalida: id,
          ...values,
      ...
      if (res.ok){
        ...
        // dispatch(fetchFrutasFicticiaGuia({ id: parseInt(id!), token, verificar_token: verificarToken }))
...
export default FormularioFrutaSolicitadaGuia
