...
import { fetchPDFGuiaSalida } from '../../../../redux/slices/pedidoSlice';
...
const PDFGuiaSalida = () => {
  ...
  useEffect(() => {
    dispatch(fetchPDFGuiaSalida({ id: parseInt(id!), token, verificar_token: verificarToken }))
  }, [])
