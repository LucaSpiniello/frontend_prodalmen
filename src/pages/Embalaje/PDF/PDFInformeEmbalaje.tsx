...
const PDFInformeEmbalaje = () => {
  ...
  state?.pallets_embalaje.forEach((pallet: any) => {
        ...
        <View style={[styles.header, { paddingVertical: 10}]}>
          ...
          <View style={{
            ...
            <View style={{
              ...
              <View style={styles.header_date_info_box}>
                <Text style={styles.header_date_info_text}>Total Kilos Embalados: </Text>
          ...
          <View style={{ 
            ...
            <View style={styles.header_info_box_superior}>
             <Text style={{ fontSize: 10, position: 'relative', top: -5}}>Codigo</Text>
            </View>
          ...
          {
            state?.pallets_embalaje.map((pallet: any) => {
              return (
                <View key={pallet.codigo_pallet} style={{ 
                  width: '100%',
                  height: 30,
                  borderRadius: 1, 
                  display: 'flex',
                  ...
                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{pallet.codigo_pallet}</Text>
                  </View>
                  ...
                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{pallet.producto}</Text>
                  </View>

                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{pallet.variedad}</Text>
                  </View>

                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{pallet.calibre}</Text>
                  </View>

                  <View style={styles.header_info_box_superior}>
                    <Text style={{ fontSize: 9, position: 'relative', top: -5, left: 0}}>{pallet.calidad}</Text>
                  </View>
...
export default PDFInformeEmbalaje