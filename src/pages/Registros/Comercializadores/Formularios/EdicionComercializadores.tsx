...
import { crearComercializador, editarComercializador, fetchComercializador } from '../../../../redux/slices/comercializadores'
...
const FormularioEdicionComercializador: FC<IFormComercializadorProps> = ({ setOpen, id }) => {
  const dispatch = useDispatch<ThunkDispatch<any, any, any>>()
  const token = useAppSelector((state: RootState) => state.auth.authTokens)
  const { isDarkTheme } = useDarkMode()
  const { data: comercializador } = useAuthenticatedFetch<TComercializador>(`api/comercializador/${id}/`)
