...
const TablaBodegaG7: FC<IBodegaG4Props> = ({ data, refresco, setRefresco }) => {
	...
	const exportToExcel = (data: Row<TBinBodega>[]) => {
		...
		XLSX.utils.book_append_sheet(wb, ws, 'Bodega G7')
		XLSX.writeFile(wb, 'bodega_g7.xlsx')
...
//     { id: 'programa', header: '', className: 'lg:w-56 text-center ' },
...
//   ]
	...
	return (
		<PageWrapper name='Lista Bodega G5' isProtectedRoute={true}>
			<Subheader>
				<SubheaderLeft>
					<FieldWrap
