...
const TablaBodegaG5: FC<IBodegaG4Props> = ({ data, refresco, setRefresco}) => {
	...
	const exportToExcel = (data: Row<TBinBodega>[]) => {
		...
		XLSX.utils.book_append_sheet(wb, ws, 'Bodega G5')
		XLSX.writeFile(wb, 'bodega_g5.xlsx')
